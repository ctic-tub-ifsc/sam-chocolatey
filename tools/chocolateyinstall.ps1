...
$url        = 'https://sam.nrel.gov/download/66-sam-2021-12-02-for-windows/file.html' # download url, HTTPS preferred
$url64      = 'https://sam.nrel.gov/download/66-sam-2021-12-02-for-windows/file.html' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'sam*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
